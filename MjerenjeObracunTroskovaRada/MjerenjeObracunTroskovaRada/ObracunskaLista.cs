    ...
    public class ObracunskaLista
    {
        ...
        public override string ToString()
        {
            return "Zaposlenik: " + ImePrezimeZaposlenika + Environment.NewLine +
                ...
                "1) Bruto placa: " + Math.Round(BrutoPlaca, 2) + Environment.NewLine +
                ...
                "Uzdrzavani clanovi uze obitelji: " + Math.Round(UzdrzavaniClanoviOsobniOdbitak, 2) + Environment.NewLine +
                "Osobni odbitak za djecu: " + Math.Round(DjecaOsobniOdbitak, 2) + Environment.NewLine +
                "Osnovica za porez na dohodak: " + Math.Round(OsnovicaZaPorezNaDohodak, 2) + Environment.NewLine +
                ...
                "Neto placa (za isplatu): " + Math.Round(NetoPlaca, 2) + Environment.NewLine +
                "Doprinos za zdravstveno osiguranje (16,5%): " + Math.Round(DoprinosZaZdravstvenoOsiguranje, 2) + Environment.NewLine;
        }
    }
}
